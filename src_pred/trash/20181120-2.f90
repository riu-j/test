    ...
    contains
      ...
      subroutine eval(a, b, c, impf, g, datrec, bm, id)
        use prdims, only: gprd
        real (kind=dpsize) :: datrec(*), impf(*), g(gprd, 1), a(*), b(*), c(*), time
        integer (kind=isize) :: bm, id, icall, j
    ...
    subroutine pred(icall, newind, theta, datrec, indxs, f, g, h)
      ...
      call eval(a, b, c, impf, g, datrec, bm, id)
      do k = 1, numbm
